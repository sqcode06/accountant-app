...
final class MVPWorkflowTests: XCTestCase {
    func testImportClassifyApplyFinalizeAndReconcileWorkflow() throws {
        ...
        XCTAssertEqual(proposed[0].draft.postings[0], Posting(accountID: bank.id, money: Money(Decimal(1000), currency: eur), role: .statement))
        XCTAssertEqual(proposed[0].draft.postings[1], Posting(accountID: salary.id, money: Money(Decimal(-1000), currency: eur), role: .counterparty))
        ...
        XCTAssertEqual(proposed[1].draft.postings[0], Posting(accountID: bank.id, money: Money(Decimal(-42), currency: eur), role: .statement))
        XCTAssertEqual(proposed[1].draft.postings[1], Posting(accountID: groceries.id, money: Money(Decimal(42), currency: eur), role: .counterparty))
        ...
        XCTAssertEqual(proposed[2].draft.postings[0], Posting(accountID: bank.id, money: Money(Decimal(-18), currency: eur), role: .statement))
        XCTAssertEqual(proposed[2].draft.postings[1], Posting(accountID: foodDelivery.id, money: Money(Decimal(18), currency: eur), role: .counterparty))
